...
console.log(post)
  return (
    <main>
        <Header/>
        <img className='w-full h-40 object-cover' src={ urlFor(post.mainImage).url()!} alt='post image'/>
        <article className='max-w-3xl mx-auto'>
            ...
            <div className='flex items-center space-x-2'>
                ...
                <p className='font-extralight text-sm'>Blog post by <span className='text-pink-500'> {post.author.name}</span> - Published at {new Date(post._createdAt).toLocaleString}</p>
            </div>
            <div className='mt-10'>
                <PortableText
            ...
            {submitted ? (<div className='flex flex-col justify-center items-center py-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto'>
                <h3 className='text-3xl font-bold'>Thank you for submitting your comment</h3>
                <p>Once it has approved,it will appear below!</p>
            </div>): (<form onSubmit={handleSubmit(onSubmit)} className='flex flex-col p-5 max-w-2xl mx-auto mb-10 '>
